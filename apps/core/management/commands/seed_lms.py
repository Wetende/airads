...
class Command(BaseCommand):
    help = 'Seeds LMS Theology School with full simulation data'
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.MIGRATE_HEADING('Creating LMS Theology School Data...'))
        ...
        # Ensure Blue Branding (LMS Brand)
        ...
        admin = self._create_user(
            email='admin@admin.com', username='lms_admin',
...
Attendance is mandatory for all students.''',
    ...
    def _print_summary(self, students_data, instructors_data, password):
        ...
        self.stdout.write(self.style.SUCCESS('✅ LMS Theology School data seeded successfully!'))
        self.stdout.write(self.style.SUCCESS('=' * 60))
        self.stdout.write('')
