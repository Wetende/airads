...
class Command(BaseCommand):
    help = 'Removes seeded data from LMS (reverses seed_lms and codeum_seed)'

    def handle(self, *args, **options):
        self.stdout.write(self.style.MIGRATE_HEADING('Removing LMS Seed Data...'))
        ...
        usernames_to_delete.append('lms_admin') # Specific admin username in seed
