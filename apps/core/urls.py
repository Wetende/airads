...
urlpatterns = [
    ...
    path("admissions/apply/", views.airads_application_apply, name="airads.application_apply"),
    path("admissions/apply/submit/", views.airads_application_submit, name="airads.application_submit"),
