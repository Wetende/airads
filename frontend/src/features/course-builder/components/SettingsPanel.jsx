                ...
                return (
                    <Stack spacing={3}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            ...
                            Curriculum tab. Enable "Requires Upload" on
                            individual lessons to require practicum submissions.
                        </Typography>
                        <Button
                            variant="outlined"
                            onClick={() =>
                ...
                return (
                    <Box sx={{ textAlign: "center", py: 4 }}>
                        <Typography color="text.secondary">
                            General settings (Description, etc.) are managed in
                        ...
                        <Button
                            ...
                            onClick={() =>
                                router.visit(
                                    `/instructor/programs/${program.id}/edit`,
                                )
                            }
                        >
