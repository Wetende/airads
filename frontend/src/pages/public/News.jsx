...
const News = () => {
  ...
  const newsItems = [
    {
      title: "SEPTEMBER 2026 INTAKE ONGOING",
      date: "July 1st, 2026",
      category: "Admissions",
      excerpt: "Applications are now open for the September 2026 intake across all our campuses. Join us for quality technical education.",
      ...
      <Box component="main" sx={{ flexGrow: 1, py: { xs: 8, md: 12 }, mt: { xs: 8, md: 12 } }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ mb: { xs: 10, md: 12 } }}>
            <Typography variant="h3" component="h2" sx={{ fontWeight: 800, color: brand.secondary, mb: 6, display: 'flex', alignItems: 'center' }}>
              Latest News
              <Box sx={{ height: 4, width: 60, bgcolor: brand.primary, ml: 3, borderRadius: 2 }} />
            </Typography>
                  ...
                  >
                    <Box sx={{ position: 'relative', pt: '56.25%', overflow: 'hidden' }}>
                      ...
                      >
                        <Chip
                          label={item.category}
                          size="small"
                          sx={{ bgcolor: brand.primary, color: 'white', fontWeight: 'bold', fontSize: '0.75rem' }}
                        />
                      </Box>
                    </Box>
                    <CardContent sx={{ flexGrow: 1, p: 3, display: 'flex', flexDirection: 'column' }}>
                      ...
                      <Button
                        ...
                        sx={{ alignSelf: 'flex-start', color: brand.primary, fontWeight: 600, px: 0, '&:hover': { bgcolor: 'transparent', color: brand.primaryHover } }}
                      >
                        Read More
                      </Button>
                    </CardContent>
                    ...
                    <Grid size={{ xs: 12, md: 8, lg: 9 }}>
                      ...
                      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: { xs: 2, md: 4 } }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', color: 'text.secondary' }}>
                          <Event sx={{ fontSize: '1.2rem', mr: 1, color: brand.primary }} />
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', color: 'text.secondary' }}>
                          <LocationOn sx={{ fontSize: '1.2rem', mr: 1, color: brand.primary }} />
