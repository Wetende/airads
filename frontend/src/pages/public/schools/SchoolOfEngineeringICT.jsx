...
const SchoolOfEngineeringICT = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <MainNavbar />
      {/* Hero Section */}
      <div className="mt-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white py-20">
