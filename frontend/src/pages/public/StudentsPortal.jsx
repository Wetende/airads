...
import { Box, Container, Typography, Grid, Card, CardContent, Paper, Avatar } from "@mui/material";
import { 
  ...
  const studentServices = [
    {
      ...
      icon: <EmojiObjects fontSize="large" sx={{ color: '#2563eb' }} />
    },
    {
      ...
      icon: <Home fontSize="large" sx={{ color: '#059669' }} />
    },
    {
      ...
      icon: <DirectionsBus fontSize="large" sx={{ color: '#e11d48' }} />
    },
    {
      ...
      icon: <SportsSoccer fontSize="large" sx={{ color: '#d97706' }} />
    },
    {
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, py: { xs: 8, md: 12 }, mt: { xs: 8, md: 12 } }}>
        <Container maxWidth="lg">
              ...
              <Grid item xs={12} sm={6} md={4} key={index}>
                ...
                >
                  <CardContent sx={{ p: 4, display: 'flex', flexDirection: 'column', height: '100%' }}>
                    <Box sx={{ mb: 3, p: 2, bgcolor: '#f8fafc', borderRadius: 3, display: 'inline-flex', alignSelf: 'flex-start' }}>
                      {service.icon}
                    </Box>
          ...
          {/* Student Resources */}
          <Box sx={{ bgcolor: '#f8fafc', p: { xs: 4, md: 8 }, borderRadius: 6 }}>
            <Typography variant="h3" component="h2" sx={{ fontWeight: 900, color: '#1e40af', mb: 6, textAlign: 'center' }}>
              Student Resources
            </Typography>
            <Grid container spacing={4}>
              {[
                { title: 'Well-furnished Libraries', desc: 'Modern libraries with extensive collections', icon: <MenuBook fontSize="large" sx={{ color: '#059669' }} /> },
                { title: 'Computer Labs', desc: 'State-of-the-art computer laboratories', icon: <Computer fontSize="large" sx={{ color: '#2563eb' }} /> },
                { title: 'Lecture Halls', desc: 'Modern lecture halls with AV equipment', icon: <AccountBalance fontSize="large" sx={{ color: '#d97706' }} /> },
                { title: 'Cafeteria', desc: 'Affordable meals and refreshments', icon: <Restaurant fontSize="large" sx={{ color: '#e11d48' }} /> }
              ].map((resource, index) => (
                <Grid item xs={12} sm={6} lg={3} key={index}>
                  ...
                  >
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 1, color: '#334155' }}>
                      {resource.title}
                    </Typography>
