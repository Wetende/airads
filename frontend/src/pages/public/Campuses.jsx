                  ...
                  <CardContent sx={{ flexGrow: 1, p: 4, display: 'flex', flexDirection: 'column' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      <Chip
                        ...
                        size="small"
                        sx={{ bgcolor: brand.softBlue, color: brand.primary, fontWeight: 600, px: 1 }}
                      />
                    </Box>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 'auto', pt: 2, borderTop: '1px solid', borderColor: brand.borderBlue }}>
                      ...
                      <Button
                        ...
                        sx={{ color: brand.primary, fontWeight: 600, '&:hover': { bgcolor: 'rgba(37, 99, 235, 0.05)' } }}
                      >
                        Visit
                      </Button>
                    </Box>
